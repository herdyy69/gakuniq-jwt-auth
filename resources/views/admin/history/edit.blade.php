...
<div class="container-fluid">
    <form action="{{ route('history.update', $histories->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode_transaksi"
                            ...
                            value="{{ $histories->kode_transaksi }}" readonly>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="waktu_pemesanan"
                            ...
                            value="{{ $histories->waktu_pemesanan }}">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ url('/admin/history') }}" class="btn btn-danger me-3"><svg
