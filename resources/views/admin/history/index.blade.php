        ...
        <div class="card h-100">
            <div class="card-body">
                <div class="d-flex w-100 justify-content-between">
                    <div class="me-2">
                        <h6 class="mb-0">Total history : </h6>
                    </div>
                    <h5 class="fw-semibold mb-0">{{ $total_histories }}</h5>
                </div>
            </div>
        </div>
    </div>
...
<div class="card shadow-lg rounded card">
    <div class="card-header" id="#atas">
        ...
        {{-- <a href="{{ route('history.create') }}" class="btn btn-sm btn-primary"><svg
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif ($history->status == 'prosess')
                            <div class="d-flex btn-sm btn-warning">
                                {{ $history->status }}
                            </div>
                            @elseif ($history->status == 'gagal')
                        ...
                        <td>
                            <form action="{{ route('history.destroy', $history->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <a href="{{ route('history.edit', $history->id) }}" class="btn btn-sm btn-success">
                                ...
                                {{-- <a href="{{ route('history.show', $history->id) }}"
                                    class="btn btn-sm btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16"
