...
@section('content')
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex w-100 justify-content-between">
                        <div class="me-2">
                            <h6 class="mb-0">Total wishlist : </h6>
                        </div>
                        <h5 class="fw-semibold mb-0">{{ $total_wishlists }}</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow-lg rounded card">
        <div class="card-header" id="#atas">
            ...
            <a href="{{ route('wishlist.create') }}" class="btn btn-sm btn-primary"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <td>
                                        <form action="{{ route('wishlist.destroy', $wishlist->id) }}" method="post">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCenter"><svg xmlns="http://www.w3.org/2000/svg"
