<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme shadow rounded">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text menu-text fw-bolder ms-2">Gakuniq</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('admin/user*') ? 'active' : '' }}">
            <a href="/admin/user" class="menu-link">
                ...
                <div data-i18n="Analytics">Akun User</div>
            </a>
        </li>
        <li
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ Request::is('admin/keranjang*') ? 'active' : '' }}">
                    <a href="/admin/keranjang" class="menu-link">
                        ...
                        <div data-i18n="Analytics">Data Keranjang</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('admin/wishlist*') ? 'active' : '' }}">
                    <a href="/admin/wishlist" class="menu-link">
                        <i class="menu-icon tf-icons bi bi-bag-heart-fill"></i>
                        <div data-i18n="Analytics">Data Wishlist</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('admin/transaksi*') ? 'active' : '' }}">
                    <a href="/admin/transaksi" class="menu-link">
                        <i class="menu-icon tf-icons bi bi-credit-card-fill"></i>
