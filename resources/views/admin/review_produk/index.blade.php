            ...
            <table class="table table-hover" id="dataTable">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                {{ $review_produk->transaksi->keranjang->user->name}}
                            </div>
                        </td>
                        <td>
                            <div class="d-flex">
                        ...
                        <td>
                            <form action="{{ route('review_produk.destroy', $review_produk->id) }}" method="post">
                                @csrf
                                @method('delete')
                                {{-- <a href="{{ route('review_produk.edit', $review_produk->id) }}"
