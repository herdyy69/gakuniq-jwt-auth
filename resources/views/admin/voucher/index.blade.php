        ...
        <div class="card h-100">
            <div class="card-body">
                <div class="d-flex w-100 justify-content-between">
                    <div class="me-2">
                        <h6 class="mb-0">Total voucher : </h6>
                    </div>
                    <h5 class="fw-semibold mb-0">{{ $total_vouchers }}</h5>
                </div>
            </div>
        </div>
    </div>
...
<div class="card shadow-lg rounded card">
    <div class="card-header" id="#atas">
        ...
        <a href="{{ route('voucher.create') }}" class="btn btn-sm btn-primary"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="d-flex btn-sm btn-success col-12">
                                <b> {{ $voucher->label }} </b>
                            </div>
                            @elseif ($voucher->label == 'berbayar')
                            <div class="d-flex btn-sm btn-danger col-12">
                                <b> {{ $voucher->label }} </b>
                            </div>
                            @endif
                        </td>
                        ...
                        <td>
                            <form action="{{ route('voucher.destroy', $voucher->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <a href="{{ route('voucher.edit', $voucher->id) }}" class="btn btn-sm btn-success">
