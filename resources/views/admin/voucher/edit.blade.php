                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="label" class="form-control @error('label') is-invalid @enderror">
                                <option value="{{ $vouchers->label }}" selected>
                                    {{ $vouchers->label }}</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="waktu_berakhir"
                                ...
                                placeholder="Waktu berakhir" value="{{ $vouchers->waktu_berakhir }}">
