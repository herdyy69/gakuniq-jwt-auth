...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('sub_kategori.update', $sub_kategoris->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="sub_kategori"
                                class="form-control mb-2  @error('sub_kategori') is-invalid @enderror"
                                value="{{ $sub_kategoris->sub_kategori }}">
                            @error('sub_kategori')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ url('/admin/sub_kategori') }}" class="btn btn-danger me-3"><svg
