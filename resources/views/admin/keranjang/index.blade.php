        ...
        <div class="card h-100">
            <div class="card-body">
                <div class="d-flex w-100 justify-content-between">
                    ...
                    <h5 class="fw-semibold mb-0">{{ $total_keranjangs }}</h5>
                </div>
            </div>
        </div>
    </div>
...
<div class="card shadow-lg rounded card">
    <div class="card-header" id="#atas">
        ...
        <a href="{{ route('keranjang.create') }}" class="btn btn-sm btn-primary"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('keranjang.destroy', $keranjang->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <a href="{{ route('keranjang.edit', $keranjang->id) }}" class="btn btn-sm btn-success">
